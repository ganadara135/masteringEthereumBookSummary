...
합의 알고리즘의 원칙과 가정은 다음과 같은 몇 가지 주요 질문을 통해 보다 명확하게 이해할 수 있습니다.  

+ 누가 어떻게 과거를 바꿀 수 있는가? (이것은 불변이라고도 한다.)  

+ 누가 어떻게 미래를 바꿀 수 있을까? (이는 최종이라고도 합니다.)  

+ 이러한 변경에 드는 비용은 얼마입니까?  

+ 그러한 변화를 만드는 힘은 얼마나 분산되어 있는가?  

+ 뭐가 변했는지, 어떻게 알 수 있을까?  

컨센서스 알고리즘은 빠르게 발전하고 있으며, 이러한 질문에 점점 더 혁신적인 방식으로 답변하려고 시도하고 있습니다.  

# Controversy and Competition
이 시점에서 여러분은 다음과 같은 의문을 가질 수 있습니다.   
왜 이렇게 다양한 합의 알고리즘이 필요한 거죠?   
어떤 게 더 잘 되나요?   
후자의 질문에 대한 답은 지난 10년 동안 분산 시스템에서 가장 흥미로운 연구 영역의 중심에 있습니다.  
이 모든 것은 가정, 목표, 피할 수 없는 균형에 대한 컴퓨터 과학의 맥락에서 "더 나은" 것으로 귀결됩니다.  

탈중앙화 합의의 문제를 모든 차원에서 최적화할 수 있는 알고리즘은 없을 가능성이 높습니다.   
누군가가 하나의 합의 알고리즘이 다른 알고리즘보다 "더 낫다"고 제안할 때, 여러분은 명확히 하는 질문을 시작해야 합니다:   
무엇을 더 잘 하느냐? 불변성, 최종성, 분산성, 비용?   
적어도 아직은 이 질문에 대한 명확한 해답이 없다.   
더욱이 합의 알고리즘 설계는 수십억 달러 산업의 중심에 있으며 엄청난 논란과 열띤 논쟁을 불러일으키고 있다.   
결국 응용 프로그램마다 정답이 다를 수 있듯이 "정답"이 없을 수도 있습니다.  

전체 블록체인 산업은 막대한 금전적 가치가 걸려 있는 적대적 조건에서 이러한 질문을 테스트하는 하나의 거대한 실험입니다.   
결국 역사는 논쟁에 답을 줄 것이다.  

# Conclusions
이 책이 완성되는 시점에도 이더리움의 컨센서스 알고리즘은 여전히 유동적이다.   
향후 에디션에서는 Casper 및 기타 관련 기술이 성숙되어 Ethereum에 배치됨에 따라 이러한 기술에 대한 자세한 내용을 추가할 예정입니다.   
이 장은 Ethereum 마스터링을 완료하는 여정의 끝을 보여줍니다.   
부록에는 다음과 같은 추가 참조 자료가 있습니다.   
이 책을 읽어주셔서 감사드리며, 마지막까지 읽을 것에 경배!!! 
